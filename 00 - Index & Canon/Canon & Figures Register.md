...
## External entities (CR-02) — supplier & regulator graph nodes
Suppliers and regulators are **first-class context nodes** (CR-02 applied 2026-06-29; RIM aligned `schema.canonical.yaml`). All names/figures already canon — no new figures; this section is the graph-anchor roster (cf. [[Annex - Supply Chain & Production]], [[Annex - External Environment & Constraints]]).
- **Suppliers (8 — `supplier` nodes):** **SUP-01 Teledyne** (Tier 1, Critical, sole-source, US — RF transponders) · **SUP-02 Saft** (Tier 1, Critical, sole-source, France, 9–12 mo lead — batteries) · **SUP-03 Northrop Grumman** / **SUP-04 Spirit AeroSystems** (Tier 1, Important, dual — composite structures) · **SUP-05 Moog** / **SUP-06 Orbital ATK** (Tier 1, Important, dual — attitude control) · **SUP-07 SpaceX** / **SUP-08 Rocket Lab** (Tier 1, Important — launch). `SUPPLIES`→ BA-PROC (components) / BA-LAUNCH (launch); `SOURCED_FROM`← ROM-01/02/03, ROL-01, SEC-02, HX-01. *(Internal AIT line = BA-MFG, no node; MSSP + Axiom narrative-only.)*
- **Regulators (5 — `regulator` nodes):** **REG-01 FCC** (47 CFR Part 25) · **REG-02 ITU** (Radio Regulations) · **REG-03 US DDTC/ITAR** (22 CFR 120–130, export_control) · **REG-04 DoD accreditation** · **REG-05 ESA/NASA** (partnership). `GOVERNS`→ ROR-01, RH-07, RA-05, ROH-02, RH-05, RC-04 (multi-jurisdiction fan-in) + HX-05 (incident). Context-only (no exposure/magnitude math).
